...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-09-24T23:36:17.929Z',
    '2023-09-25T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
// Show accounts usernames and passwrods
alert(`There are 2 accounts you can log into:
...
console.log(+(2.345).toFixed(2));
// Numbers are primitvies and don't have methods, so behind the scenes it does boxing and converts it to a number object

console.log(new String('string'));
console.log(new String(23));
...
// const PI = _3._1415_; // Not allowed => beginning and start, next to dot (only between numbers)
// const PI = 3.14__15; // Not allowed => 2 underscores together (only one)
const PI = 3.14_15;
console.log(PI);

console.log(Number('230000'));
console.log(Number('230_000'));
console.log(Number.parseInt('230_ 000'));
console.log(parseInt('230_ 000'));
...
console.log(34854398523948327401112243438293434n);
console.log(BigInt(34854398523948327401112243438293434));
console.log(BigInt(3485439852));

// Operations
console.log(10000n + 10000n);
console.log(6348264392402347238439578943563000040n * 100000000n);
// console.log(Math.sqrt(16n));
// console.log(Math.max(15n, 16n));

const huge = 3474389750923423493478234234n;
const num = 23;
...
console.log(new Date('Sep 24 2023 17:43:22'));
